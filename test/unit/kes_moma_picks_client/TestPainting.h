...
#ifndef TEST_UNIT_KES_MOMA_PICKS_CLIENT_TESTPAINTING_H_
#define TEST_UNIT_KES_MOMA_PICKS_CLIENT_TESTPAINTING_H_
...
#endif  // TEST_UNIT_KES_MOMA_PICKS_CLIENT_TESTPAINTING_H_
