...
sys.path.insert(0, abspath(join(
    dirname(__name__), '..', '..', 'include'
)))

breathe_projects = {
    "mercury": abspath(join(
        dirname(__name__), '..', 'build', 'doxygen', 'xml'
    ))
}
...
latex_documents = [
    (master_doc, 'mercury.tex', u'Mercury Documentation',
...
man_pages = [
    (master_doc, 'mercury', u'Mercury Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mercury', u'Mercury Documentation',
     author, 'mercury', 'Cross-platform Kano abstraction layer.',
     'Miscellaneous'),
]
